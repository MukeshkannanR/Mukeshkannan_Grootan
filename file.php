...
<html>
   ...
   <body>
     <div class="container">
      <br />
      <h3 align="center">Import CSV File to Mysql</h3>
      <br />
        <div class="panel panel-default">
          <div class="panel-heading">Import  CSV File to Mysql </div>
          <div class="panel-body">
          <div class="table-responsive">

          <span id="message"></span>

              <form action="file.php" method="post" id="import_excel_form" enctype="multipart/form-data">
                <table class="table">
                  <tr>
